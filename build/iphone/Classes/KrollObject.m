 ...
 * Copyright (c) 2009-2011 by TutorialUsingCommonJS, Inc. All Rights Reserved.
...
//@interface TutorialUsingCommonJSObject : NSObject
//@end

@interface TutorialUsingCommonJSObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TutorialUsingCommonJSObject class]])
		{
			for (NSString *key in [[(TutorialUsingCommonJSObject*)o modules] allKeys])
			{
