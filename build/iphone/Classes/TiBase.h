...
// in simulator we redefine to format for TutorialUsingCommonJS Developer console
...
{\
	NSString * exceptionName = [@"org.tutorialusingcommonjs." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tutorialusingcommonjs";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITutorialUsingCommonJSNativeItemNone = -1, 
	UITutorialUsingCommonJSNativeItemSpinner = -2,
	UITutorialUsingCommonJSNativeItemProgressBar = -3,
	
	UITutorialUsingCommonJSNativeItemSlider = -4,
	UITutorialUsingCommonJSNativeItemSwitch = -5,
	UITutorialUsingCommonJSNativeItemMultiButton = -6,
	UITutorialUsingCommonJSNativeItemSegmented = -7,
	
	UITutorialUsingCommonJSNativeItemTextView = -8,
	UITutorialUsingCommonJSNativeItemTextField = -9,
	UITutorialUsingCommonJSNativeItemSearchBar = -10,
	
	UITutorialUsingCommonJSNativeItemPicker = -11,
	UITutorialUsingCommonJSNativeItemDatePicker = -12,
	
	UITutorialUsingCommonJSNativeItemInfoLight = -13,
	UITutorialUsingCommonJSNativeItemInfoDark = -14,
	
	UITutorialUsingCommonJSNativeItemDisclosure = -15,
	
	UITutorialUsingCommonJSNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all TutorialUsingCommonJS instances of
